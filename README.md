...
| `previousSessionRecall.tokenLimit` | 1000 | Token budget for previous-session recall; 1/3 head + 2/3 tail allocation (head and tail each force-include at least 1 message) |
